...
<div align="center">
  <!-- You are encouraged to replace this logo with your own! Otherwise you can also remove it. -->
    <br>
  <h1 style="font-size: 35px; color: lightblue"><b>Space Traveler's Hub</b></h1>
...
# 📖 Space Traveler's Hub <a id="about-project"></a>

**Space Traveler's Hub Project** is a Single Page App (SPA) implemeted using React and Redux that has 2 pages:
1. The Rockets section displays a list of all available SpaceX rockets. Users can book each rocket by clicking the reservation button or cancel the previously made booking.
2. The Missions section displays a list of current missions along with their brief description and participation status. There is also a button next to each mission that allows users to join the selected mission or leave the mission the user joined earlier.displayed
3. It uses an external API to SpaceX's API to gather data to be displayed on each page
...
- **Rockets' List of SpaceX** which displays the name, description, reservation possibility of each rocket
- **Missions' List of space journeys** which displays different missions including their name, description and status and wether you can join or not.
